...
import {  getCountries, getCity } from 'pages/api/getWay/index' //接口
...
const SearchForm = () => {
  ...
  return (
    <FormWrapper>
      ...
      <ComponentWrapper>
        <FaMapMarkerAlt className="map-marker" />
          <Form layout={'inline'} style={{width: '100%'}} {...formItemLayout} form={form}>
            <Space>
            <Form.Item style={{width: '50%'}} name="Countries">
              <Select style={{marginLeft: '40px',width: '150%'}} placeholder="Countries" bordered={false} onChange={changeCountries}>
                {
            ...
            <Form.Item style={{width: '50%'}} name="City">
              <Select style={{marginLeft: '5px', width: '200%'}} placeholder="City" bordered={false}>
                {
